...
namespace max7219_matrix {
    ...
    */
    ...
    //% num.min=1 num.defl=1 cs.defl=DigitalPin.P14 mosi.defl=DigitalPin.P15 miso.defl=DigitalPin.P20 sck.defl=DigitalPin.P13 rotate.defl=false group="1. Setup"
    ...
    */
    //% block="Rotate matrix display $rotation|Reverse printing order $reversed" rotation.defl=rotation_direction.none group="1. Setup" blockExternalInputs=true 
